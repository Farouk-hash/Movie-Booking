export const signupStyle = {
    ...
    leftSide: {
        ...
        content: "relative z-10 flex flex-col justify-center items-start text-white p-12 ml-16"
    },
    ...
    rightSide: {
        ...
        formContainer: {
            base: "w-full max-w-md bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 p-4",
            header: {
